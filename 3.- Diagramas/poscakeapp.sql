...
CREATE TABLE IF NOT EXISTS `poscakeapp`.`Insumo_has_Producto` (
  ...
  INDEX `fk_Insumo_has_Producto_Proveedor1_idx` (`Proveedor_idProveedor` ASC),
  INDEX `fk_Insumo_has_Producto_Producto1_idx` (`Producto_idProducto` ASC, `Producto_Empresa_idEmpresa` ASC, `Producto_Categoria_idCategoria` ASC),
  CONSTRAINT `fk_Insumo_has_Producto_Proveedor1`
